...
begin 
	...
	nn_plot = plot(df.time, [df.NN1, df.NN2], label="NN Unknown", title="NN-approximated unknown function", xlabel = "Time [min]", ylabel = "x(t)", left_margin=(5,:mm), linewidth=2)
	plot!(df.time, df.Xact_fit, label="Ground truth", linewidth=2)
...
begin
	...
	plot(g1p_plot, g2p_plot, Xact_plot, layout=(3,1), size=(800, 1200))

...
begin
	...
	const U = Lux.Chain(Lux.Dense(7, 25, rbf), Lux.Dense(25, 25, rbf), Lux.Dense(25, 25, rbf), Lux.Dense(25, 1))
...
[[deps.Lux]]
deps = ["ADTypes", "Adapt", "ArrayInterface", "ChainRulesCore", "ConcreteStructs", "ConstructionBase", "FastClosures", "Functors", "GPUArraysCore", "LinearAlgebra", "LuxCore", "LuxDeviceUtils", "LuxLib", "MacroTools", "Markdown", "PrecompileTools", "Random", "Reexport", "Setfield", "Statistics", "WeightInitializers"]
git-tree-sha1 = "ee59fa47785cd00f557cdf4bf8849e7c1b47d9e3"
...
git-tree-sha1 = "526e6366f76da0d354705eeef633c9d80149c5b3"

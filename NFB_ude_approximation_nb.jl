...
begin
	...
	# External libraries
	using Lux, Zygote, StableRNGs, JLD2
...
This notebook contains the code to solve a UDE problem, i.e. an ODE problem designed with unknown functional parts that are approximated by a neural network. The ODE system that was used is the simple Negative Feedback Loop model (NFB) of two phosphatases g1p and g2p as described by D. Daniels, M. Dobrzyński, D. Fey in "Quantitative Biology: Theory, Computational Methods and Examples of Models", Chapter 12: Parameter Estimation, Sloppiness, and Model Identifiability (2018).\
The neural network output can then be saved in CSV format (time seried data).
"""

# ╔═╡ f26afbca-1fbf-4338-b3de-cd74e920f48d
md"""
##### Simulate data with noise for the four following cases:
- no feedback loop
...
begin
	...
	x̄_g2p_ab = Statistics.mean(x_g2p_ab, dims = 1)
...
begin
	...
	filename = "NFB_ab_005"    # keep format <NFB_'case'_'CC'> for compatibility
	xₙ_g2p = xₙ_g2p_ab
	X = X_ab
end
...
begin
	...
	res1 = Optimization.solve(optprob1, OptimizationOptimisers.Adam(), callback = callback, maxiters = 5000, abstol=1e-12, reltol = 1e-12)
...
begin
	...
	pl_losses = plot(1:length(losses), losses, yaxis = :log10, xaxis = :log10,
	                 xlabel = "Iterations", ylabel = "Loss", color = :blue)
...
begin
	...
	nn_plot = plot(time, û[1,:], label="Û₁ approximated by NN", colour=:blue, title="NN approximation")
	plot!(nn_plot, time, û[2,:], label="Û₂ approximated by NN", colour=:green)

	if occursin("no", filename)
...
manifest_format = "2.0"
project_hash = "13305fcf9488d42f288e040557d7f5c96d135b5b"
...
git-tree-sha1 = "b63695bc543a45cab4f30e039c26ca3bcc6780a1"
...
git-tree-sha1 = "7fb808ef6421ea58c607657eea17caa9f03c08d0"
...
git-tree-sha1 = "b8c120986fce117469760119f44592ff148da93e"
...
git-tree-sha1 = "8001e387f5d07fef98160d62fc89aafacbc3266f"
...
git-tree-sha1 = "d9a3531a7772c09a763cc4da2d9d0394d3417cdc"
...
git-tree-sha1 = "bf8bca6f9f9fa3fa984ba5d358595033f0aace2a"
...
[[deps.Optimization]]
deps = ["ADTypes", "ArrayInterface", "ConsoleProgressMonitor", "DocStringExtensions", "LBFGSB", "LinearAlgebra", "Logging", "LoggingExtras", "MLUtils", "OptimizationBase", "Printf", "ProgressLogging", "Reexport", "SciMLBase", "SparseArrays", "TerminalLoggers"]
git-tree-sha1 = "ef6cd5f04320e39f6e61027295ed1b3f2fbbeab6"
uuid = "7f7a1694-90dd-40f0-9382-eb1efda571ba"
version = "4.0.2"

[[deps.OptimizationBase]]
deps = ["ADTypes", "ArrayInterface", "DifferentiationInterface", "DocStringExtensions", "FastClosures", "LinearAlgebra", "PDMats", "Reexport", "Requires", "SciMLBase", "SparseArrays", "SparseConnectivityTracer", "SparseMatrixColorings", "SymbolicAnalysis", "SymbolicIndexingInterface", "Symbolics"]
git-tree-sha1 = "f6acffdbcd4288efaa500b495d078a677d224eb2"
uuid = "bca83a33-5cc9-4baa-983d-23429ab6bcbb"
version = "2.0.4"
weakdeps = ["Enzyme", "FiniteDiff", "ForwardDiff", "ModelingToolkit", "ReverseDiff", "Zygote"]
...
git-tree-sha1 = "fb491b21cce372e90041f84e7ced8ae7620758aa"
uuid = "36348300-93cb-4f02-beb5-3c3902f8871e"
version = "0.4.0"

[[deps.OptimizationOptimisers]]
deps = ["Optimisers", "Optimization", "Printf", "ProgressLogging", "Reexport"]
git-tree-sha1 = "3509be535d7b3e1b41daf88e74468849c0139ee8"
uuid = "42dfb2eb-d2b4-4451-abcd-913932933ac1"
version = "0.3.2"
weakdeps = ["MLDataDevices", "MLUtils"]

    [deps.OptimizationOptimisers.extensions]
...
git-tree-sha1 = "97a7e10717bd27e600ba55da9d90a5628c1a403b"
...
git-tree-sha1 = "fe315c033fd22e892ec822055351869b7ee7df8f"
...
git-tree-sha1 = "6a7c7cd9bd8c051877a5a29fb597b18362dbc4e4"
